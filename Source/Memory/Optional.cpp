...
void HE::OptionalTest::Prepare()
{
    ...
    AddTest(
        ...
        [this](auto& ls)
        {
            ...
            if (&aValue != &x)
            {
                ls << "Optional<ref> value address is incorrect! ptr = " << (void*)(&aValue)
                   << ", but " << (void*)(&x) << " expected." << lferr;
            }
        });
    ...
    AddTest(
        ...
        [this](auto& ls)
        {
            ...
            if (conCount != 2)
            {
                ls << "Constructing Count = " << conCount << ", but expected 1" << lferr;
            }

            if (desCount != 0)
            {
                ls << "Destructing Count = " << desCount << ", but expected 0" << lferr;
            }
            ...
            if (a.Value().x != 1)
            {
                ls << "Optional value = " << a.Value().x << ", but expected 0." << lferr;
            }
        });
}
