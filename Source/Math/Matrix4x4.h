...
namespace hbe
{
	...
	public:
		...
		inline This Inverse() const
		{
			...
			result.m12 = invDet * (m12 * m34 * m43 + m13 * m32 * m44 + m14 * m33 * m42 - m12 * m33 * m44 -
								   m13 * m34 * m42 - m14 * m32 * m43);
			result.m13 = invDet * (m12 * m23 * m44 + m13 * m24 * m42 + m14 * m22 * m43 - m12 * m24 * m43 -
								   m13 * m22 * m44 - m14 * m23 * m42);
			result.m14 = invDet * (m12 * m24 * m33 + m13 * m22 * m34 + m14 * m23 * m32 - m12 * m23 * m34 -
								   m13 * m24 * m32 - m14 * m22 * m33);
			result.m21 = invDet * (m21 * m34 * m43 + m23 * m31 * m44 + m24 * m33 * m41 - m21 * m33 * m44 -
								   m23 * m34 * m41 - m24 * m31 * m43);
			result.m22 = invDet * (m11 * m33 * m44 + m13 * m34 * m41 + m14 * m31 * m43 - m11 * m34 * m43 -
								   m13 * m31 * m44 - m14 * m33 * m41);
			result.m23 = invDet * (m11 * m24 * m43 + m13 * m21 * m44 + m14 * m23 * m41 - m11 * m23 * m44 -
								   m13 * m24 * m41 - m14 * m21 * m43);
			result.m24 = invDet * (m11 * m23 * m34 + m13 * m24 * m31 + m14 * m21 * m33 - m11 * m24 * m33 -
								   m13 * m21 * m34 - m14 * m23 * m31);
			result.m31 = invDet * (m21 * m32 * m44 + m22 * m34 * m41 + m24 * m31 * m42 - m21 * m34 * m42 -
								   m22 * m31 * m44 - m24 * m32 * m41);
			result.m32 = invDet * (m11 * m34 * m42 + m12 * m31 * m44 + m14 * m32 * m41 - m11 * m32 * m44 -
								   m12 * m34 * m41 - m14 * m31 * m42);
			result.m33 = invDet * (m11 * m22 * m44 + m12 * m24 * m41 + m14 * m21 * m42 - m11 * m24 * m42 -
								   m12 * m21 * m44 - m14 * m22 * m41);
			result.m34 = invDet * (m11 * m24 * m32 + m12 * m21 * m34 + m14 * m22 * m31 - m11 * m22 * m34 -
								   m12 * m24 * m31 - m14 * m21 * m32);
			result.m41 = invDet * (m21 * m33 * m42 + m22 * m31 * m43 + m23 * m32 * m41 - m21 * m32 * m43 -
								   m22 * m33 * m41 - m23 * m31 * m42);
			result.m42 = invDet * (m11 * m32 * m43 + m12 * m33 * m41 + m13 * m31 * m42 - m11 * m33 * m42 -
								   m12 * m31 * m43 - m13 * m32 * m41);
			result.m43 = invDet * (m11 * m23 * m42 + m12 * m21 * m43 + m13 * m22 * m41 - m11 * m22 * m43 -
		...
		inline Number Determinant() const
		{
			return m11 * m22 * m33 * m44 + m11 * m23 * m34 * m42 + m11 * m24 * m32 * m43 + m12 * m21 * m34 * m43 +
				   ...
				   m13 * m24 * m31 * m42 + m14 * m21 * m33 * m42 + m14 * m22 * m31 * m43 + m14 * m23 * m32 * m41

				   - m11 * m22 * m34 * m43 - m11 * m23 * m32 * m44 - m11 * m24 * m33 * m42 - m12 * m21 * m33 * m44 -
				   m12 * m23 * m34 * m41 - m12 * m24 * m31 * m43 - m13 * m21 * m34 * m42 - m13 * m22 * m31 * m44 -
