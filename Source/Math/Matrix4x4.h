...
namespace HE
{
    ...
    public:
        ...
        inline This Inverse() const
        {
            ...
            FatalAssert(
                row == column && det != 0, "The matrix is not invertible.");
            ...
            result.m23 = invDet *
                (m11 * m24 * m43 + m13 * m21 * m44 + m14 * m23 * m41 -
            ...
            result.m34 = invDet *
                (m11 * m24 * m32 + m12 * m21 * m34 + m14 * m22 * m31 -
            ...
            result.m43 = invDet *
                (m11 * m23 * m42 + m12 * m21 * m43 + m13 * m22 * m41 -
        ...
        {
            return m11 * m22 * m33 * m44 + m11 * m23 * m34 * m42 +
                m11 * m24 * m32 * m43 + m12 * m21 * m34 * m43 +
                m12 * m23 * m31 * m44 + m12 * m24 * m33 * m41 +
                m13 * m21 * m32 * m44 + m13 * m22 * m34 * m41 +
                m13 * m24 * m31 * m42 + m14 * m21 * m33 * m42 +
                m14 * m22 * m31 * m43 + m14 * m23 * m32 * m41

                - m11 * m22 * m34 * m43 - m11 * m23 * m32 * m44 -
                m11 * m24 * m33 * m42 - m12 * m21 * m33 * m44 -
                m12 * m23 * m34 * m41 - m12 * m24 * m31 * m43 -
                m13 * m21 * m34 * m42 - m13 * m22 * m31 * m44 -
                m13 * m24 * m32 * m41 - m14 * m21 * m32 * m43 -
                m14 * m22 * m33 * m41 - m14 * m23 * m31 * m42;
        }

        inline bool IsOrthogonal() const
        {
            return IsZero(rows[0].Dot(rows[1])) &&
                IsZero(rows[1].Dot(rows[2])) && IsZero(rows[2].Dot(rows[3])) &&
                IsZero(rows[3].Dot(rows[0])) && rows[0].IsUnity() &&
